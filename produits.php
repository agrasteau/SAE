    ...
    <div class="container">
        <div class="leftColumn">
            ...
            <form action="insert_products.php" method="post" enctype="multipart/form-data">
                ...
                <input type="text" pattern="[A-Za-z0-9 ]{0,100}" name="nomProduit" placeholder="<?php echo $htmlNomProduit?>" required><br><br>
                ...
                <br>
                <br>
                <input type="submit" value="<?php echo $htmlAjouterLeProduit?>">
            </form>
            </center>
